...
class CustomerServiceBot:
    ...
    def __init__(self, api_key: str, model: str = "gpt-3.5-turbo", use_vocareum: bool = False):
        """
        ...
        if use_vocareum or api_key.startswith("voc"):
            self.client = OpenAI(
        ...
        # Load the system prompt that defines the bot's behavior
...
Respond with ONLY the category name, nothing else."""
        ...
        try:
            # Make an API call to get the classification
            ...
            # Extract and return the intent category
...
def main():
    ...
    # Initialize the bot
    bot = CustomerServiceBot(api_key, use_vocareum=True)
